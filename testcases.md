...
| TC005 | Login Failure - User Does Not Exist | High | Functional, Negative | - | 1. Navigate to "Sign In" page<br>2. Enter non-existent email<br>3. Enter any password<br>4. Click "Sign In" | - Error message displayed indicating incorrect sign-in<br>- User is NOT logged in | Email: unconnected@test.com |
...
| TC008 | Reset Password - Link Validation | Medium | Functional | Email triggered | 1. Open Reset Password link from email (Simulated)<br>2. Enter New Password & Confirm<br>3. Click "Set a New Password" | - Success message: "You updated your password."<br>- User can login with new password | - |
